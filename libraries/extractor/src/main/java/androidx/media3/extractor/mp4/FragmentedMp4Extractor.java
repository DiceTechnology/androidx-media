...
public class FragmentedMp4Extractor implements Extractor {
  ...
  private boolean readAtomHeader(ExtractorInput input) throws IOException {
    ...
    if (DebugUtil.isDebugCmafAtomAllowed()) {
      DebugUtil.i("atom header [" + Mp4Box.getBoxTypeString(atomType) + "], size " + atomSize
  ...
  private void readAtomPayload(ExtractorInput input) throws IOException {
    ...
    if (DebugUtil.isDebugCmafAtomAllowed()) {
      DebugUtil.i("atom payload [" + Mp4Box.getBoxTypeString(atomType)
  ...
  private void readEncryptionData(ExtractorInput input) throws IOException {
    ...
    if (DebugUtil.isDebugCmafAtomAllowed()) {
      DebugUtil.i("atom encrypt data [" + Mp4Box.getBoxTypeString(atomType)
